...
export const meals: Meal[] = [
  ...
  // Indian Breakfast
  {
    ...
    dietTypes: ["Balanced", "Vegetarian"],
    prepTime: 15,
    description: "Light and fluffy flattened rice with peanuts, curry leaves, and spices",
    instructions: [
      "Rinse 1 cup poha (flattened rice) and drain well",
      "Heat 1 tablespoon oil in a pan, add mustard seeds",
      ...
      "Serve hot with optional sev on top"
    ]
  },
  {
    ...
    fats: 7,
    type: "Breakfast",
    tags: ["Filling", "Savory", "South Indian"],
    dietTypes: ["Balanced", "Vegetarian"],
    prepTime: 20,
    description: "Savory semolina cooked with vegetables and aromatic spices",
    instructions: [
      "Dry roast 1 cup semolina (rava) until fragrant, set aside",
      "Heat 2 tablespoons oil or ghee in a pan",
      "Add mustard seeds, urad dal, and chana dal",
      "Add curry leaves, green chilies, and ginger",
      "Sauté chopped onions, carrots, and peas",
      "Add 2.5 cups water and bring to boil",
      "Slowly add roasted semolina while stirring continuously",
      "Cook covered for 5 minutes until thick",
      "Garnish with coriander and serve with coconut chutney"
    ]
  },
  {
    ...
    fats: 4,
    type: "Breakfast",
    tags: ["Steamed", "Healthy", "South Indian"],
    dietTypes: ["Balanced", "Vegetarian", "Low Fat"],
    prepTime: 25,
    description: "Soft steamed rice cakes served with lentil vegetable stew",
    instructions: [
      "Prepare idli batter (or use ready-made batter)",
      ...
      "Add vegetables (drumstick, tomato, onion)",
      "Add sambar powder and tamarind pulp",
      "Temper with mustard seeds, curry leaves, and hing",
      "Serve 3-4 idlis with hot sambar and coconut chutney"
    ]
  },
  {
    name: "Masala Dosa",
    ...
    fats: 10,
    type: "Breakfast",
    tags: ["Crispy", "South Indian", "Filling"],
    dietTypes: ["Balanced", "Vegetarian"],
    prepTime: 30,
    description: "Crispy rice and lentil crepe filled with spiced potato masala",
    instructions: [
      "Prepare dosa batter (or use ready-made fermented batter)",
      "For masala: Boil and mash 2 potatoes",
      "Temper with mustard seeds, curry leaves, onions",
      "Add turmeric, masala powder, and mix with potatoes",
      "Heat tawa/griddle and spread thin layer of batter",
  ...
  },
  {
    ...
    fats: 12,
    type: "Breakfast",
    tags: ["Stuffed", "North Indian", "Filling"],
    dietTypes: ["Balanced", "Vegetarian"],
    prepTime: 35,
    description: "Whole wheat flatbread stuffed with spiced potato filling",
    instructions: [
      "Make dough with 2 cups whole wheat flour and water",
      "Boil, peel, and mash 2 potatoes",
      "Mix potatoes with cumin, coriander, chili, and salt",
      "Divide dough into balls and roll into small circles",
      "Place potato filling in center and seal edges",
      "Roll gently into flatbread",
  ...
  },
  {
    ...
    fats: 7,
    type: "Breakfast",
    tags: ["Gujarati", "Healthy", "Travel Friendly"],
    dietTypes: ["Balanced", "Vegetarian"],
    prepTime: 30,
    description: "Spiced flatbread made with fenugreek leaves and whole wheat flour",
    instructions: [
      "Mix 2 cups whole wheat flour with 1 cup chopped fenugreek leaves",
      "Add turmeric, chili powder, coriander powder, and salt",
      "Add yogurt, oil, and knead into soft dough",
      "Let dough rest for 15 minutes",
      "Divide into balls and roll into thin circles",
      "Cook on medium-hot tawa until golden spots appear",
      "Apply ghee on both sides",
      "Serve with pickle or yogurt",
      "Great for travel as they stay fresh longer"
    ]
  },
  {
    name: "Besan Chilla",
    ...
    prepTime: 15,
    description: "Savory chickpea flour pancake with vegetables and spices",
    instructions: [
      "Mix 1 cup besan (chickpea flour) with water to make thin batter",
      "Add chopped onions, tomatoes, and green chilies",
      "Add turmeric, red chili powder, and salt",
      "Mix in chopped coriander leaves",
      "Heat non-stick pan and pour ladle of batter",
      "Spread into thin circle",
  ...
  // Indian Lunch
  {
    ...
    fats: 8,
    type: "Lunch",
    tags: ["Comfort Food", "Protein Rich", "Traditional"],
    dietTypes: ["Balanced", "Vegetarian", "High Protein"],
    prepTime: 40,
    description: "Yellow lentils tempered with ghee, cumin, and aromatic spices served with rice",
    instructions: [
      "Pressure cook 1 cup toor dal with turmeric for 3-4 whistles",
      "Mash dal and add water to desired consistency",
      "For tadka: Heat 2 tablespoons ghee in small pan",
      "Add cumin seeds, dried red chilies, and curry leaves",
      "Add chopped garlic, onions, and tomatoes",
      "Pour tadka over cooked dal",
      "Add garam masala and simmer for 5 minutes",
      "Cook 1 cup rice separately",
      "Serve dal over rice with papad and pickle"
    ]
  },
  {
    name: "Chole Bhature",
    ...
    fats: 18,
    type: "Lunch",
    tags: ["North Indian", "Street Food", "Festive"],
    dietTypes: ["Balanced", "Vegetarian"],
    prepTime: 50,
  ...
  },
  {
    ...
    fats: 22,
    type: "Lunch",
    tags: ["Rich", "North Indian", "Popular"],
    dietTypes: ["Balanced", "Vegetarian"],
    prepTime: 35,
    description: "Soft paneer cubes in rich tomato-butter gravy with naan bread",
    instructions: [
      "Cube 200g paneer and lightly fry until golden",
      "Blend tomatoes, onions, and cashews into paste",
      "Cook paste with butter, ginger-garlic paste",
      "Add kasuri methi, garam masala, and cream",
      "Add paneer cubes and simmer for 5 minutes",
      "For naan: Make dough with flour, yogurt, and yeast",
      "Let rise for 2 hours",
      "Roll and cook on hot tawa, apply butter",
      "Serve paneer masala with hot naan"
    ]
  },
  {
    name: "Rajma Chawal",
    ...
    instructions: [
      ...
      "Pressure cook with salt until soft (5-6 whistles)",
      "Sauté onions, ginger-garlic paste, and tomatoes",
      "Add rajma masala, turmeric, and red chili powder",
      "Add cooked beans with cooking water",
      "Simmer for 20 minutes until thick gravy forms",
      "Mash some beans to thicken further",
      "Cook basmati rice separately",
      "Serve rajma over rice with onion salad"
    ]
  },
  {
    ...
    fats: 16,
    type: "Lunch",
    tags: ["Healthy", "North Indian", "Iron Rich"],
    dietTypes: ["Balanced", "Vegetarian"],
    prepTime: 35,
    description: "Fresh spinach curry with soft paneer cubes served with whole wheat roti",
    instructions: [
      "Blanch 500g spinach and blend to smooth paste",
      "Cube and lightly fry 150g paneer",
      "Sauté cumin, ginger-garlic paste, onions, and tomatoes",
      "Add spinach puree and cook for 5 minutes",
      "Add garam masala, kasuri methi, and cream",
      "Add paneer cubes and simmer",
      "For roti: Make whole wheat dough",
      "Roll into thin circles and cook on hot tawa",
      "Serve palak paneer with hot rotis"
    ]
  },
  {
  ...
  },
  {
    ...
    fats: 10,
    type: "Lunch",
    tags: ["Dry Curry", "North Indian", "Simple"],
    dietTypes: ["Balanced", "Vegetarian"],
    prepTime: 30,
    ...
    instructions: [
      ...
      "Add ginger, turmeric, coriander, and cumin powder",
  ...
  // Indian Dinner
  {
    ...
    fats: 20,
    type: "Dinner",
    tags: ["Rich", "High Protein", "Popular"],
    dietTypes: ["Balanced", "High Protein"],
    prepTime: 45,
    description: "Grilled chicken in creamy tomato-based curry with aromatic spices",
    instructions: [
      "Marinate 400g chicken with yogurt, ginger-garlic, and spices for 2 hours",
      "Grill or pan-fry marinated chicken until charred",
      "Prepare gravy: Cook onion-tomato paste with butter",
      "Add kasuri methi, garam masala, and cream",
      "Add grilled chicken pieces to gravy",
  ...
  },
  {
    ...
    fats: 28,
    type: "Dinner",
    tags: ["Rich", "Creamy", "North Indian"],
    dietTypes: ["Balanced", "High Protein"],
    prepTime: 50,
    description: "Tender chicken in rich, creamy tomato-butter gravy",
    instructions: [
      "Marinate 400g chicken with yogurt, tandoori masala, and lemon juice",
      "Grill or tandoor chicken until slightly charred",
      "Blend tomatoes with cashews into smooth paste",
      "Cook paste with butter and whole spices",
      "Add cream, kasuri methi, and honey",
      "Add chicken pieces and cook for 10 minutes",
      "Finish with heavy cream and butter",
  ...
  },
  {
    ...
    dietTypes: ["Balanced", "High Protein"],
    prepTime: 90,
    description: "Layered aromatic rice with spiced chicken, saffron, and herbs",
    instructions: [
      "Marinate 500g chicken with yogurt, biryani masala, ginger-garlic",
      "Soak 2 cups basmati rice for 30 minutes",
      "Cook marinated chicken until 80% done",
      "Parboil rice with whole spices until 70% done",
      "Layer rice and chicken in heavy-bottomed pot",
      "Add fried onions, mint, coriander, and saffron milk",
      "Seal pot and cook on dum (low heat) for 25 minutes",
      "Let rest for 10 minutes before opening",
      "Serve hot with raita, shorba, and boiled egg"
    ]
  },
  {
    name: "Rogan Josh",
    ...
    fats: 28,
    type: "Dinner",
    tags: ["Kashmiri", "Rich", "Aromatic"],
    dietTypes: ["Balanced", "High Protein", "Low Carb"],
    prepTime: 60,
    description: "Aromatic Kashmiri lamb curry with yogurt and whole spices",
    instructions: [
      "Cut 500g lamb into cubes",
      "Heat mustard oil and add whole spices",
      "Brown lamb pieces on high heat",
      "Add ginger-garlic paste and yogurt",
      "Add Kashmiri red chili powder for color",
      "Cook covered until lamb is tender (45 minutes)",
  ...
  },
  {
    ...
    fats: 16,
    type: "Dinner",
    tags: ["Bengali", "Spicy", "Coastal"],
    dietTypes: ["Balanced", "High Protein"],
    prepTime: 40,
    description: "Fresh fish in mustard and tomato-based curry with Bengali spices",
    instructions: [
      "Marinate 400g fish with turmeric and salt",
      "Shallow fry fish pieces until golden, set aside",
      "Make paste with mustard seeds, green chilies, and water",
      "Heat mustard oil, temper with panch phoron",
      "Add onion paste and tomatoes",
      "Add mustard paste and cook for 5 minutes",
      "Add water to make gravy consistency",
      "Gently add fried fish pieces",
      "Simmer for 10 minutes, serve with steamed rice"
    ]
  },
  {
    name: "Dal Makhani",
    ...
    instructions: [
      "Soak 1 cup black urad dal overnight",
      "Pressure cook dal with rajma and salt until very soft",
      "Mash dal roughly",
      "Sauté ginger-garlic paste, onions, and tomatoes in butter",
      "Add dal and simmer for 30 minutes, stirring regularly",
      "Add cream, butter, and kasuri methi",
      "Cook on low heat until thick and creamy",
      "Finish with cream and butter swirl",
  ...
  },
  {
    ...
    dietTypes: ["High Protein", "Low Carb"],
    prepTime: 45,
    description: "Yogurt-marinated grilled chicken with fresh mint chutney",
    instructions: [
      "Make cuts in 500g chicken pieces",
      "Marinate with yogurt, tandoori masala, lemon juice, ginger-garlic",
      "Let marinate for at least 4 hours or overnight",
      "Grill in tandoor or oven at 220°C for 25-30 minutes",
      "Baste with butter while grilling",
      "For chutney: Blend mint, coriander, green chilies, yogurt",
      "Add lemon juice and salt",
      "Serve chicken hot with chutney and onion rings",
      "Garnish with lemon wedges and chat masala"
    ]
  },
];